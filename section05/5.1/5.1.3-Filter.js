...
let incompleteTask = data.filter(task => task.completed == false);
console.log(incompleteTask);
// filter for user 6's tasks
let userSixTasks = data.filter(task => task.userId === 6);
console.log(userSixTasks);
// filter for user 6's completed tasks
// let userSixCompletedTasks = data.filter(
//   task => task.userId === 6 && task.completed == true
// );
// console.log(userSixCompletedTasks);
let userSixCompletedTasks = userSixTasks.filter(task => task.completed == true);
console.log(userSixCompletedTasks);

// filter for tasks with a title less than 24 characters long
let shortTitles = data.filter(task => task.title.length < 24);
